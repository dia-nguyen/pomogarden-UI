...
function Modal({ children, closeModal, title }) {
  return (
    <div className="w-full h-full absolute flex justify-center items-center z-10">
      <div className="border-wood-lg-dark relative bg-white rounded-lg shadow relative w-1/3 z-20 p-5 min-w-[400px] m-2">
      ...
      <div className="bg-gray-900 bg-opacity-50 dark:bg-opacity-30 fixed inset-0 backdrop-blur"></div>
    </div>
  );
}
